...
const timeline = [
  {
    year: "2024",
    title: "AhmerZ Founded",
    description: "Established AhmerZ to provide comprehensive full-stack development services, focusing on startups and agencies worldwide."
  },
  {
    year: "2023",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="heading-1">
              About <span className="gradient-text">AhmerZ</span>
            </h1>
            <div className="space-y-4 text-muted-foreground">
              <p>
                AhmerZ is a leading full-stack development company specializing in
          ...
          >
            <div className="relative h-96 w-full rounded-lg overflow-hidden">
              <Image
                ...
                alt="AhmerZ - Professional Development Team"
                fill
